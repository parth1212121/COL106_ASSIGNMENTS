...
void Chaining::createAccount(std::string id, int count) {       // Added to the database....
...
std::vector<int> Chaining::getTopK(int k) {                      // O(nlogn).
...
int Chaining::hash(std::string id) {                                       // Basic For instance.....
